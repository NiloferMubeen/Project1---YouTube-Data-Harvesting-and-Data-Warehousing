...
my_db = my_client['Youtube_test']
my_col = my_db['channel_info']
def mongo_store():
...
d1 = []
for x in my_col.find({"channel_details.channel_id":user_input},{"_id":0,"channel_details":1,"video_details":1,
                                                                "playlist_details":1,"Comments":1}): 
       d1.append(x)
